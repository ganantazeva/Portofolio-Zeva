...
<body>
          ...
          <div class="slide" id="1">
            <div class="content first-content">
              <div class="container-fluid">
                  <div class="col-md-3">
                      <div class="author-image"><img src="img/header_image.jpg" alt=""></div>
                  </div>
                  <div class="col-md-9">
                      <h2>Zeva Gananta Putra</h2>
                      <p>Halo! Nama saya Zeva Gananta Putra. Saya tinggal di Desa Purabaya, Kecamatan Purabaya, Kabupaten Sukabumi. Saya senang bisa berbagi cerita, pengalaman, dan pengetahuan dengan Anda melalui situs ini.</p>
                      <div class="main-btn"><a href="#2">Read More</a></div>
                      <div class="fb-btn"><a href="https://web.facebook.com/zeva.gananta.7" target="_blank">Our FB Page</a></div>
                      <div class="fb-btn"><a href="https://www.instagram.com/gnntzv/" target="_blank">instagram Page</a></div>
                      <div class="fb-btn"><a href="https://web.facebook.com/zeva.gananta.7" target="_blank">gmail</a></div>
                  </div>
              </div>
            </div>
          </div>
                ...
                <div class="container-fluid">
                    <div class="col-md-6">
                        <div class="left-content">
                            <h2>About</h2>
                            <p>Halo! Nama saya Zeva Gananta Putra. Saya tinggal di Desa Purabaya, Kecamatan Purabaya, Kabupaten Sukabumi. Saya adalah seorang pengembang situs web yang sedang menekuni bidang ini dengan semangat dan dedikasi tinggi. Selain itu, saya memiliki minat yang besar dalam fotografi, mendengarkan musik, dan traveling.</p> 
                           <p>Saya memiliki pengalaman dan pendidikan yang kuat dalam jurusan TeknikI informatika, yang memberikan saya landasan yang kokoh untuk mengembangkan keterampilan dalam pengembangan web. Saya selalu berusaha untuk memperbarui pengetahuan saya dengan tren dan teknologi terbaru dalam industri ini.</p>
                           <p>Visi saya adalah untuk terus berkembang dan berinovasi dalam setiap aspek pekerjaan saya. Saya percaya bahwa setiap proyek adalah peluang untuk belajar dan menciptakan sesuatu yang unik dan bernilai. Misi saya adalah untuk memberikan solusi yang memenuhi kebutuhan klien dan memberikan dampak positif.</p>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="left-content">
                                                <h2>Sertifikat</h2>
                                                <p>Sebagai pengakuan atas partisipasinya dalam program pelatihan intensif Machine Learning. Pelatihan ini mencakup teori dasar, algoritma, dan aplikasi praktis dari Machine Learning, serta penggunaan alat dan teknik terbaru dalam bidang ini</p>
                                                <div class="main-btn"><a href="#4">Continue Reading</a></div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-image">
                                                <img src="img/Zeva Gananta Putra.jpg" alt="first service">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="left-image">
                                                <img src="img/senja.jpg" alt="second service">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="right-content">
                                                <h2>Photografer</h2>
                                                <p>Foto ini diambil saat matahari mulai tenggelam di disebuah desa nyalindung. Warna oranye  berpadu dengan awan tipis, menciptakan pemandangan senja yang mempesona dan menenangkan.</p>
                                                <div class="main-btn"><a href="#4">Continue Reading</a></div>
                                            </div>
                                        </div>
                                    </div>
	...
	-->
                    ...
                    <div class="col-md-6">
                    <form id="contact" action="DataKontakController.php" method="post">
    <div class="row">
        <div class="col-md-12">
            <fieldset>
